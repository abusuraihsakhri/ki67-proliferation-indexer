"""
Automated Pytest for ki67-proliferation-indexer Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    Ki67proliferationindexerEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = Ki67proliferationindexerEnrichmentSuite()
